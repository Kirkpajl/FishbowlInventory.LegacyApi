...
namespace FishbowlInventory
{
    public sealed class FishbowlInventoryApiClient : IDisposable
    {
        ...
        private static string ToCsv(PurchaseOrderItem purchaseOrderItem)
        {
            ...
            csv.Add(purchaseOrderItem.DateScheduled?.ToShortDateString());  // "FulfillmentDate"
            csv.Add(purchaseOrderItem.DateLastFulfilled?.ToShortDateString());  // "LastFulfillmentDate"
