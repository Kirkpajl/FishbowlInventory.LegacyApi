...
namespace FishbowlInventory.Api.Endian
{
    internal class EndiannessAwareBinaryReader : BinaryReader
    {
        ...
        public short ReadInt16(Endianness endianness) => endianness == Endianness.LittleEndian
        ...
        public ushort ReadUInt16(Endianness endianness) => endianness == Endianness.LittleEndian
        ...
        public int ReadInt32(Endianness endianness) => endianness == Endianness.LittleEndian
        ...
        public uint ReadUInt32(Endianness endianness) => endianness == Endianness.LittleEndian
        ...
        public long ReadInt64(Endianness endianness) => endianness == Endianness.LittleEndian
        ...
        public ulong ReadUInt64(Endianness endianness) => endianness == Endianness.LittleEndian
